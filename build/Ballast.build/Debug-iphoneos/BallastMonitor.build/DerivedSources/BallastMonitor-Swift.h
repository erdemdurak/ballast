...
#ifndef BALLASTMONITOR_SWIFT_H
#define BALLASTMONITOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BallastMonitor",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_RESILIENT_CLASS("_TtC14BallastMonitor14BallastMonitor")
@interface BallastMonitor : DeviceActivityMonitor
