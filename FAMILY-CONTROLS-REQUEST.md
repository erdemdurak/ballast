...
runs, Hold Focus reminds them of that task — on the Lock Screen and through notifications
...
FamilyActivityPicker. Because Apple returns opaque tokens, Hold Focus never learns which
...
or team mode, no remote configuration, and no reporting to any third party. Hold Focus
...
This extension belongs to Hold Focus, a personal focus reminder. It is the
...
Authorization is `.individual` only. Hold Focus is a tool a person points at themselves; it
